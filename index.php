...
<div class="container-fluid" style="margin: 0;padding: 0;">
    <div class="image" style="margin-top: -21px">
        <img src="image/home/phome.jpg" style="width: 100%;  height: 650px;">
    </div>
</div>
<br>
<br>
...
<div class="container">
    ...
    <h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #ff8d87; border-bottom: 2px solid #ff8d87;">
        Website ini menyediakan makanan khas yogyakartaaa.</h4>
                    ...
                    <div class="caption">
                        ...
                        <div class="row">
                            ...
                            <?php if (isset($_SESSION['kd_cs'])) { ?>
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-success btn-block" role="button"><i class="glyphicon glyphicon-shopping-cart"></i> Tambah</a>
                                </div>
                            <?php
                            } else {
                            ?>
