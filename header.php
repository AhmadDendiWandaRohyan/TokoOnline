...
<head>
    <meta charset="UTF-8">
    <title>TOKO-KULINER-JOGJA</title>
        ...
        <div class="row top">
            <center>
                <div class="col-md-4" style="padding: 3px;">
                    <span> <i class="glyphicon glyphicon-earphone"></i> 082331844648</span>
                </div>


                <div class="col-md-4" style="padding: 3px;">
                    <span><i class="glyphicon glyphicon-envelope"></i> Ujang@gmail.com</span>
                </div>


                <div class="col-md-4" style="padding: 3px;">
                    <span>JOGJA FOOD HUNTER</span>
                </div>
            </center>
        </div>
    </div>
    ...
    <nav class="navbar navbar-default" style="padding: 5px;">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="color: #ff8680" font-size=10px;><b>JOGJA FOOD</b></a>
            </div>
