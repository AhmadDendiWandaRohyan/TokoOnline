<footer style="border-top: 4px solid #ff8680;  ">
    <div class="container" style="padding-bottom: 50px;">
        <div class="row">
            <div class="col-md-4">
                <h3 style="color: #ff8680"><b>JOGJA FOOD HUNTER</b></h3>
                <p>Jl. Tanah Merah Indah 1 No.10C</p>
                <p><i class="glyphicon glyphicon-earphone"></i> 082323547423</p>
                <p><i class="glyphicon glyphicon-envelope"></i> Ujang@gmail.com</p>
            </div>
            <div class="col-md-4">
                <h5><b>Menu</b></h5>
